...
const (
	...
	PeopleFollowersURL      = "https://peoplehub.xboxlive.com/users/me/people/followers"
	PeopleSocialURL         = "https://peoplehub.xboxlive.com/users/me/people/social"
	PeopleFriendRequestsURL = "https://peoplehub.xboxlive.com/users/me/people/friendrequests(received)"

	SocialBulkFriendsURL = "https://social.xboxlive.com/bulk/users/me/people/friends/v2?method=add"
)
...
func ProfileLookupURL(gamertag string) string {
	return "https://profile.xboxlive.com/users/gt(" + gamertag + ")/profile/settings?settings=Gamertag"
}
